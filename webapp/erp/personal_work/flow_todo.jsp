...
function createProcessMethod(rowObj) {
	...
	if (rowObj.task.assignee == null){
		...
		str += "<a href='javascript:void(0)' title='办理' onclick=\"handle('"+rowObj.config.handlePage+"','" + rowObj.processInstance.businessKey + "','" + rowObj.task.id + "','" + rowObj.task.taskDefinitionKey + "')\"><img src='<%=contextPath%>/images/grid_images/rowedit.png' border='0'/></a>";
	}
